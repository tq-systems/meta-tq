...
# Currently only i.MX8[M,MMini,MNano,MPlus] and i.MX9[1,3,4,5] have support to override
# the debug / boot UART base address.
ATF_IMX_BOOT_UART_BASE ??= "INVALID"
# We return INVALID here since this is highly machine dependend.
# Currently only i.MX94 hase support to override UART baudrate
ATF_IMX_BOOT_UART_BAUD ??= "INVALID"
...
IMX_EXTRA_OEMAKE_UART:mx94-generic-bsp = "\
    IMX_LPUART_BASE=${ATF_IMX_BOOT_UART_BASE} \
    IMX_CONSOLE_BAUDRATE=${ATF_IMX_BOOT_UART_BAUD} \
"
