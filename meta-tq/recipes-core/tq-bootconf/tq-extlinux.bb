...
UBOOT_EXTLINUX_VARS = "MENU_DESCRIPTION KERNEL_IMAGE FDT FDTDIR INITRD KERNEL_ARGS KERNEL_ARGS_EXTRA ROOT CONSOLE"
do_create_extlinux_config[vardeps] += "${@' '.join(['UBOOT_EXTLINUX_%s' % v for v in d.getVar('UBOOT_EXTLINUX_VARS').split()])}"
