...
Changes of the image format and signing for the additional components of the
chain of trust beyond U-Boot SPL are out of scope of the example implementation.
