...
The signed images for i.MX8M generated by `imx-mkimage` version `lf-6.1.55_2.2.0` are
not compatible to older versions of this tool. Care must be taken when updating image
generation and boot loader.
