# gitpkgv-nonexact.bbclass provides a GITPKGV and GITPKGVTAG variables to be
...
#
# - GITPKGVTAG which is the output of 'git describe --tags'
...
#
# gitpkgv-nonexact.bbclass is mostly identical to gitpkgv.bbclass from
# meta-openembedded; it only drops the "--exact-match" argument to make
# the class work for commits that aren't tagged.
#
# use example:
#
